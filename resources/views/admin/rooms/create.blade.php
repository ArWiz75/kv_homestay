                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('admin.rooms.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="price_weekly" class="block mt-1 w-full" type="number" name="price_weekly" :value="old('price_weekly')" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="price_monthly" class="block mt-1 w-full" type="number" name="price_monthly" :value="old('price_monthly')" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="amenities" class="block mt-1 w-full" type="text" name="amenities" :value="old('amenities')" />
                            <x-input-error :messages="$errors->get('amenities')" class="mt-2" />
                        </div>

                        <!-- Image -->
                        <div class="mb-4">
                            <x-input-label for="image" :value="__('Foto Kamar (Opsional)')" />
                        ...
                        <div class="block mt-4 mb-6">
                            <label for="is_popular" class="inline-flex items-center">
                                <input id="is_popular" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_popular" value="1" {{ old('is_popular') ? 'checked' : '' }}>
